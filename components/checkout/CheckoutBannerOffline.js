...
function CheckoutBannerOffline({courseId}) {
    ...
    const makePayment=async(e)=>{
        ...
        const payload = {
            ...
            amount: course.price,
            redirectUrl: `https://www.gammaprep.in/pi/users/status/${transactionid}?courseId=${courseId}`,
            redirectMode: "POST",
            callbackUrl: `https://www.gammaprep.in/users/status/${transactionid}?courseId=${courseId}`,
