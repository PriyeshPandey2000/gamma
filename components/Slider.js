...
//         <div className={`slide ${0 === middleCardIndex && animateMiddleCard ? 'animate' : ''}`}>
//           <Component />
//         </div>
//         <div className={`slide ${1 === middleCardIndex && animateMiddleCard ? 'animate' : ''}`}>
//           <Component />
//         </div>
//         <div className={`slide ${2 === middleCardIndex && animateMiddleCard ? 'animate' : ''}`}>
//           <Component />
//         </div>
//       </div>
//       <style jsx>{`
