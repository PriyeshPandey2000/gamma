...
function SBanner2({ title, description, reviewRating, reviewCount, studentsPlaced ,courseId,canEnroll,course}) {
    ...
    <div className="relative">
      ...
      {!isXsScreen && (
        <div className="absolute top-14 right-24 z-10">
          <Card courseId={courseId} canEnroll={canEnroll} course={course}/>
        </div>
      )}
