  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="mt-5 text-xl leading-8 text-center text-black max-md:max-w-full">
        Welcome to GammaPrep! DSA for Cracking the Coding Interview. Animated
        Examples for Faster Learning and Deeper Understanding. Lorem ipsum dolor
      ...
      <div onClick={handleDashboardClick} className="justify-center items-center px-16 py-4 mt-8 max-w-full text-xl font-medium leading-8 text-center text-white bg-sky-800 rounded-[70px] w-[599px] max-md:px-5">
